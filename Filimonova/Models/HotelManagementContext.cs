...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=PPC\\SQLEXPRESS;Database=hotel_management;TrustServerCertificate=True; Trusted_Connection=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Guest>(entity =>
        {
            ...
            entity.Property(e => e.DoocumentNumber)
                .HasMaxLength(50)
                .HasColumnName("doocument_number");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.Property(e => e.PeymentMethod)
                .HasMaxLength(50)
                .HasColumnName("peyment_method");
            entity.Property(e => e.ReservationId).HasColumnName("reservation_id");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Statistics_hotel");
